...
|` i ` | positive integer number | Position coordinate in the y axis | cell units|
|` j ` | positive integer number | Position coordinate in the x axis | cell units|
...
|`i` | positive integer number | Position coordinate in the y axis | cell units | variable|
|`j` | positive integer number | Position coordinate in the x axis | cell units | variable|
