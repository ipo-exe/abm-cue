...
if __name__ == "__main__":
    ...
    lst_file = list()
    s_dir_samples_url = "https://github.com/ipo-exe/abm-cue/blob/main/samples"
    s_file_url = "https://github.com/ipo-exe/abm-cue/blob/main/docs/iodocs.md"
    # import
    ...
    for i in range(len(df_io)):
        if df_io["Source"].values[i] == "imported by user":
            ...
            if os.path.isfile(s_lcl_path):
                df_io["Sample"].values[i] = (
                    "[Sample file]("
                    + s_dir_samples_url
                    + "/"
                    + df_io["File Name"].values[i]
                    + ")"
                )
            else:
    ...
    lst_table = [["File", "Source", "Format", "Sample"], ["File", "Source", "Format"]]
    ...
    for cat in lst_cats:
        ...
        append_table(
            df=df_lcl[["Keyword", "Data Type", "Description", "Units", "Category"]]
        )
